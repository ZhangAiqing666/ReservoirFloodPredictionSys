...
type Biz struct {
	state                    protoimpl.MessageState `protogen:"open.v1"`
	DefaultRunoffCoefficient float32                `protobuf:"fixed32,1,opt,name=default_runoff_coefficient,json=defaultRunoffCoefficient,proto3" json:"default_runoff_coefficient,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *Biz) GetDefaultRunoffCoefficient() float32 {
	if x != nil {
		return x.DefaultRunoffCoefficient
	}
	return 0
}
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x03biz\x18\x03 \x01(\v2\x0f.kratos.api.BizR\x03biz\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\x03Biz\x12<\n" +
	"\x1adefault_runoff_coefficient\x18\x01 \x01(\x02R\x18defaultRunoffCoefficientB-Z+ReservoirFloodPrediction/internal/conf;confb\x06proto3"
